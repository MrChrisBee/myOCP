...
public class ResolveDemo {
	public static void main(String[] args) {
		String s11 = "a/b";// falls other kein absoluter pfad ist, wird other an this angehängt
		String s12 = "c/d";
		Path p11 = Paths.get(s11);
		Path p12 = Paths.get(s12);
		System.out.println(p11.resolve(p12)); // a/b/c/d
		String s21 = "a/b";// falls other kein absoluter pfad ist, wird other an this angehängt
		String s22 = "/c/d";
